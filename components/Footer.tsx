...
export default function Footer() {
  return (
         <footer className="bg-brand-off-white text-brand-brown">
        ...
        <div className="py-12">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="space-y-4">
                       ...
                       Especialistas em empadas e tortas artesanais com ingredientes selecionados. 
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                                       <Link
                         href="#produtos"
                         className="block text-brand-brown hover:text-brand-red transition-colors duration-200"
                       >
                         Nossos Produtos
                       </Link>
                       <Link
                         href="https://www.queroempada.com.br"
                         target="_blank"
                ...
                <div className="flex items-center space-x-2">
                  <svg className="w-5 h-5 text-brand-yellow" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                           ...
                           className="text-brand-brown hover:text-brand-red transition-colors duration-200"
                         >
                           (19) 98601-5465
                         </Link>
                       </div>
          ...
          <div className="border-t border-gray-300 mt-8 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              <p className="text-brand-brown text-sm">
                © 2025 Quero Empada. Todos os direitos reservados.
              </p>
